...
class BattleScript extends FlxBasic implements IFlxDestroyable
{
    ...
    public function new(scriptName:String, menu:BattleMenu)
    {
        super();
        ...
        var rawScript = null;
        #if MODS_ALLOWED
		var moddyFile:String = Paths.modFolders("battleScripts/"+scriptName+".hx");
        ...
        {
            lime.app.Application.current.window.alert(e.message, 'Error on battle script .hx!');
            return;
        }
        init();
        //trace(rawScript);
